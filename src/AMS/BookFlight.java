...
public class BookFlight extends JFrame implements ActionListener {
        ...
        c3.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                try {
                    ...
                    String q1 = "SELECT DISTINCT price FROM flight WHERE sourcee=? AND destination=? AND classname=?";
                    pst = o.con.prepareStatement(q1);
                    pst.setString(1, source);
                    pst.setString(2, destination);
                    ...
                    while (rss.next()) {
                        prices.add(rss.getString("price"));
                    }
        ...
        c4.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                try {
                    ...
                    String destination = c6.getSelectedItem();
                    String classname = c3.getSelectedItem();
                    String price = c4.getSelectedItem();
                    String q1 = "SELECT DISTINCT fcode FROM flight WHERE sourcee=? AND destination=? AND classname=? AND price=?";
                    pst = o.con.prepareStatement(q1);
                    pst.setString(1, source);
                    pst.setString(2, destination);
                    pst.setString(3, classname);
        ...
        c5.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                try {
                    ...
                    String classname = c3.getSelectedItem();
                    String price = c4.getSelectedItem();
                    String fcode = c5.getSelectedItem();
                    String q1 = "SELECT fname, journey_date, journey_time FROM flight WHERE sourcee=? AND destination=? AND classname=? AND price=? AND fcode=?";
                    pst = o.con.prepareStatement(q1);
                    pst.setString(1, source);
                    pst.setString(2, destination);
                    pst.setString(3, classname);
                    pst.setString(4, price);
                    pst.setString(5, fcode);
                    rss = pst.executeQuery();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            if (source == null || destination == null || classname == null || price == null || fcode == null || 
                source.isEmpty() || destination.isEmpty() || classname.isEmpty() || price.isEmpty() || fcode.isEmpty() || 
                fname.isEmpty() || journey_date.isEmpty() || journey_time.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Vui lòng chọn đầy đủ chi tiết chuyến bay trước khi đặt.");
                return;
            }
            ...
            try {
                ...
                if (a == 1) {
                    ...
                    JOptionPane.showMessageDialog(null, "Vui lòng điền đầy đủ chi tiết cẩn thận.");
                }
            } catch (Exception ex) {
                ex.printStackTrace();
