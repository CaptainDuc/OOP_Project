...
public class AddPassengerDetails extends JFrame implements ActionListener {
    ...
    public AddPassengerDetails() {
        ...
        l3 = new JLabel("Welcome to the Airlines");
        ...
        l6 = new JLabel("Date of Birth (DD-MM-YYYY)");
        l6.setBounds(400, 200, 250, 30); 
        l6.setFont(new Font("Arial", Font.BOLD, 15));
        l6.setForeground(Color.BLACK);
        l1.add(l6);

        tf4.setBounds(650, 200, 100, 30);
        l1.add(tf4);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == bt1) {
            ...
            if (username.isEmpty() || name.isEmpty() || age.isEmpty() || phone.isEmpty() || passport.isEmpty()) {
                JOptionPane.showMessageDialog(f, "Vui lòng điền đầy đủ các trường bắt buộc (Username, Name, Age, Phone, Passport).", "Thiếu thông tin", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            try {
                ...
                String g = "INSERT INTO passenger (username, namee, age, dob, addresss, phone, email, nationality, gender, passport) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if (e.getSource() == bt2) {
            JOptionPane.showMessageDialog(null, "Hủy bỏ");
            f.setVisible(false);
        }
    }
